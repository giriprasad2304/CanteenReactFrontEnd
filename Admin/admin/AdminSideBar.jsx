...
import { clearAuth } from '../../FrontEnd/src/store/authSlice'
import axios from 'axios'

const links = [
    {
        to: '/admin', end: true, label: 'Orders',
    ...
    {
        to: '/admin/menu', end: false, label: 'Menu',
...
const AdminSideBar = () => {
    ...
    return (
        <div className="admin-sidebar">
            <div className="admin-sidebar-logo">Crave<span>Canteen</span> Admin</div>
            {links.map(l => (
